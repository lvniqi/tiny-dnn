...
#include "tiny_dnn/layers/bit_layer.h"
...
namespace tiny_dnn {
	...
	**/
	...
	class feedforward_bit_bit_layer : public bit_layer {
	public:
		explicit feedforward_bit_bit_layer(const std::vector<vector_type> &in_data_type)
			: bit_layer(in_data_type, std_output_order(true)) {}
