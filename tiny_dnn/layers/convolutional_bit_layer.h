...
namespace tiny_dnn {
	...
	**/
	...
	class convolutional_bit_layer : public feedforward_bit_layer<Activation> {
	public:
		typedef feedforward_bit_layer<Activation> Base;
		...
		**/
		convolutional_bit_layer(serial_size_t in_width,
			...
			: convolutional_bit_layer(in_width,
				in_height,
				window_size,
				window_size,
				in_channels,
		...
		**/
		...
		// move constructor
		convolutional_bit_layer(convolutional_bit_layer &&other)  // NOLINT
			: Base(std::move(other)),
